package com.tugasday1.shoppy_isra.activity;
...
import com.tugasday1.shoppy_isra.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //menerima data yang di kirimkan dari putExtra
        String usersucceslogin = getIntent().getStringExtra("Muhammad Isra");
